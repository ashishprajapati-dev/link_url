...
link_url is the best gem for converting url from the string or text into the links. It can convert the url's which contain http://, https and www. from the string. No need to thing about the REGEX.
